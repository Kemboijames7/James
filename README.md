...
<div align="center">
  ...
  >
    ...
    <desc id="descId">A graph showing the languages I use most often.</desc>
    <style>
      .header {
    ...
    >
      <svg data-testid="lang-items" x="25">
        ...
        <rect
          ...
          x="0"
          y="0"
          width="89.55"  <!-- Adjust these widths -->
          height="8"
          fill="#3178c6"
        />
        ...
        <rect
          mask="url(#rect-mask)"
          data-testid="lang-progress"
          x="89.55" <!-- Adjust these starting x positions-->
          y="0"
          width="56.95"  <!-- Adjust these widths -->
          height="8"
          fill="#f1e05a"
        />
        ...
        <rect
          mask="url(#rect-mask)"
          data-testid="lang-progress"
          x="146.5"   <!-- Adjust these starting x positions-->
          y="0"
          width="37.08"  <!-- Adjust these widths -->
          height="8"
          fill="#e34c26"
        />
        ...
        <rect
          mask="url(#rect-mask)"
          data-testid="lang-progress"
          x="183.57999999999998"  <!-- Adjust these starting x positions-->
          y="0"
          width="27.89"  <!-- Adjust these widths -->
          height="8"
          fill="#663399"
        />
        ...
        <rect
          mask="url(#rect-mask)"
          data-testid="lang-progress"
          x="211.46999999999997"  <!-- Adjust these starting x positions-->
          y="0"
          width="27.82"  <!-- Adjust these widths -->
          height="8"
          fill="#b07219"
        />
        ...
        <rect
          mask="url(#rect-mask)"
          data-testid="lang-progress"
          x="239.28999999999996"  <!-- Adjust these starting x positions-->
          y="0"
          width="10.72"  <!-- Adjust these widths -->
          height="8"
          fill="#3572A5"
        />
...
<!-- Badges and other content below -->
![Node.js](https://img.shields.io/badge/Node.js-339933?style=for-the-badge&logo=nodedotjs&logoColor=white)
![MongoDB](https://img.shields.io/badge/MongoDB-47A248?style=for-the-badge&logo=mongodb&logoColor=white)
